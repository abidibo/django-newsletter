...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.creation_date'
        db.alter_column(u'newsletter_job', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Newsletter.creation_date'
        db.alter_column(u'newsletter_newsletter', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Newsletter.last_edit_date'
        db.alter_column(u'newsletter_newsletter', 'last_edit_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

        # Changing field 'Subscription.date'
        db.alter_column(u'newsletter_subscription', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'JobDispatch.date'
        db.alter_column(u'newsletter_jobdispatch', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Job.creation_date'
        db.alter_column(u'newsletter_job', 'creation_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Newsletter.creation_date'
        db.alter_column(u'newsletter_newsletter', 'creation_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Newsletter.last_edit_date'
        db.alter_column(u'newsletter_newsletter', 'last_edit_date', self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True))

        # Changing field 'Subscription.date'
        db.alter_column(u'newsletter_subscription', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'JobDispatch.date'
        db.alter_column(u'newsletter_jobdispatch', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        u'newsletter.newsletter': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_edit_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
